...
// Components call `useTranslation()` outside any test-specific provider;
// react-i18next throws/warns ("NO_I18NEXT_INSTANCE") and falls back to raw
// keys unless an instance exists before the first render.
initializeI18n();
