...
export function SplitWorkspaceSecondaryPanelHost({
  ...
  const toggleLabel = isOpen
    ? t("views.threadDetail.secondaryPanelHost.hideRightPanel")
    : t("views.threadDetail.secondaryPanelHost.showRightPanel");
          ...
          {model === null ? (
            <>
              ...
              <PanelResizeHandle
                ...
                aria-label={t(
                  "views.threadDetail.secondaryPanelHost.resizeRightPanel",
                )}
              >
                <span
                  aria-hidden
              ...
              >
                ...
                >
                  <EmptyStatePanel className="flex-1 rounded-lg">
                    {t("views.threadDetail.secondaryPanelHost.emptyPanelMessage")}
                  </EmptyStatePanel>
                </div>
              </Panel>
            </>
