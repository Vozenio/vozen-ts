...
export function ThreadDetailHeader({
  ...
  const rightPanelLabel = isSecondaryPanelOpen
    ? t("views.threadDetail.header.hideRightPanel")
    : t("views.threadDetail.header.showRightPanel");
        ...
        <Pill variant="outline" size="sm">
          {t(
            childPillLabel === "child"
              ? "views.threadDetail.header.childPill"
              : "views.threadDetail.header.sideChatPill",
          )}
        </Pill>
      ) : null}
      {/*
      ...
      >
        ...
        {onClosePane ? (
          <Button
            ...
            aria-label={t("views.threadDetail.header.closePane")}
            onClick={onClosePane}
          >
