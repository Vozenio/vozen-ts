    ...
    () =>
      hasAnyThreadMetadata(metadata, hasForks) ? (
        ...
        <div className="px-4 pt-1 text-sm text-muted-foreground">
          {t("views.threadDetail.secondaryContent.noDetailsAvailable")}
        </div>
      ),
    [hasForks, isMetadataLoading, metadata, t],
  );
  ...
  return (
    ...
    >
      <SecondaryPanelLayout
        ...
        drawerLabel={t("views.threadDetail.secondaryContent.drawerLabel")}
