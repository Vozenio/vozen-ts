...
export function ThreadDetailPromptArea({
  ...
  const promptPlaceholder = isStopRequested
    ? t("views.threadDetail.promptArea.composer.stoppingThreadPlaceholder")
      ...
      appToast.error(
        getMutationErrorMessage({
          ...
          fallbackMessage: isQueuingMessage
            ? t("views.threadDetail.promptArea.errors.queueMessageFailed")
            : t("views.threadDetail.promptArea.errors.sendMessageFailed"),
          ...
          try {
            ...
            appToast.error(
              getMutationErrorMessage({
                error: nextError,
                fallbackMessage: t(
                  "views.threadDetail.promptArea.errors.sendMessageFailed",
                ),
  ...
  const bottomExecutionConfig = useMemo(
    () => ({
      ...
      footerAction: {
        label: t("views.threadDetail.promptArea.execution.handoffToNewThread"),
  ...
  const sentMessageEditorPortal = useMemo(() => {
    ...
    return createPortal(
      <InlineMessageEditorFrame
        cancelLabel={t(
          "views.threadDetail.promptArea.sentMessageEditor.stopEditingLabel",
        )}
        label={t("views.threadDetail.promptArea.sentMessageEditor.editingLabel")}
      ...
      >
        {buildInlineDraftComposer({
          ...
          compactPromptPlaceholder: t(
            "views.threadDetail.promptArea.sentMessageEditor.editMessagePlaceholder",
          ),
          ...
          submitTitle: t(
            "views.threadDetail.promptArea.sentMessageEditor.submitEditTitle",
          ),
