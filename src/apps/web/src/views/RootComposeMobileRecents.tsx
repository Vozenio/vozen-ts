  ...
  return (
    <li>
      <Link
        ...
        aria-label={t("views.rootCompose.mobileRecents.openThread", {
          title: threadTitle,
          indicatorSuffix: indicatorLabel ? ` — ${indicatorLabel}` : "",
        })}
        className={cn(
  ...
  return (
    ...
    >
      <div className="mb-1 px-2">
        ...
        >
          {t("views.rootCompose.mobileRecents.recent")}
        </h2>
      </div>
      {showCreatingRow ? (
        <div
        ...
        >
          <span className="min-w-0 flex-1 truncate">
            {t("views.rootCompose.mobileRecents.creatingThread")}
          </span>
          <span className="flex size-6 shrink-0 items-center justify-center">
            <Icon
              name="Loading"
