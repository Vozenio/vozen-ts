...
function getNewThreadPromptPlaceholder(
  ...
  return isProjectless
    ? t("promptbox.newThreadPromptBox.placeholderProjectless")
    : t("promptbox.newThreadPromptBox.placeholder");
}
...
const DefaultNewThreadComposer = memo(function DefaultNewThreadComposer({
  ...
  const placeholder =
    placeholderOverride ??
    getNewThreadPromptPlaceholder(t, isProjectlessPrompt);
  ...
  const submitTitle = isSubmitting
    ? t("promptbox.newThreadPromptBox.submitting")
    : execution.model.isLoading
      ? t("promptbox.newThreadPromptBox.loadingModels")
      : t("promptbox.newThreadPromptBox.submitEnter");
