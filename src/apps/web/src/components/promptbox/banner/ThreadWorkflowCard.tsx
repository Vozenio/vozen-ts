...
function agentProgressLabel(
  ...
  return t("promptbox.threadWorkflowCard.agentProgress", {
    settled,
    total: agents.length,
  });
}
...
export function ThreadWorkflowCard({
  ...
  const progress = agentProgressLabel(t, workflow);
  return (
    <PromptStackCard
      ariaLabel={t("promptbox.threadWorkflowCard.ariaLabel")}
    ...
    >
      <div className="flex items-center">
        <button
          ...
          aria-label={t("promptbox.threadWorkflowCard.toggleAriaLabel", {
            name,
          })}
          onClick={onToggle}
