    ...
    >
      <div className="flex items-center gap-1.5">
        <Button
          ...
          disabled={dragDisabled}
          aria-label={t("promptbox.queuedMessagesList.reorderMessage", {
            index: index + 1,
          })}
          {...attributes}
          {...listeners}
          ...
          <div className="flex min-w-0 items-center gap-1">
            ...
            {attachmentCount > 0 ? (
              <span
                ...
                aria-label={
                  attachmentCount === 1
                    ? t("promptbox.queuedMessagesList.attachmentCountOne")
                    : t("promptbox.queuedMessagesList.attachmentCountOther", {
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      aria-label={t("promptbox.queuedMessagesList.sendNowAria", {
                        index: index + 1,
                      })}
                    >
                  ...
                  <TooltipContent>
                    {t("promptbox.queuedMessagesList.sendNow")}
                  </TooltipContent>
                </Tooltip>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      aria-label={t("promptbox.queuedMessagesList.editAria", {
                        index: index + 1,
                      })}
                    >
                  ...
                  <TooltipContent>
                    {t("promptbox.queuedMessagesList.edit")}
                  </TooltipContent>
                </Tooltip>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      aria-label={t(
                        "promptbox.queuedMessagesList.deleteAria",
                        { index: index + 1 },
                      )}
                    >
                  ...
                  <TooltipContent>
                    {t("promptbox.queuedMessagesList.delete")}
                  </TooltipContent>
                </Tooltip>
              </div>
            </TooltipProvider>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  disabled={actionDisabled}
                  aria-label={t(
                    "promptbox.queuedMessagesList.actionsMenuAria",
                    { index: index + 1 },
                  )}
                >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  disabled={disabled}
                  aria-label={t(
                    "promptbox.queuedMessagesList.groupBoundaryHandle",
                  )}
                  {...attributes}
                  {...listeners}
                >
              ...
              <TooltipContent>
                {t("promptbox.queuedMessagesList.groupBoundaryHandle")}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
  ...
  return (
    ...
    >
      ...
      <InlineMessageEditorFrame
        cancelLabel={t("promptbox.queuedMessagesList.stopEditing")}
        label={t("promptbox.queuedMessagesList.editingMessage", {
          index: editor.queuedMessageIndex + 1,
        })}
...
export function QueuedMessagesList({
  ...
  const processingLabel =
    processingAction === "edit"
      ? t("promptbox.queuedMessagesList.editing")
      : processingAction === "delete"
        ? t("promptbox.queuedMessagesList.deleting")
        : t("promptbox.queuedMessagesList.sending");
  ...
  const caretLabel = caretWillCollapse
    ? t("promptbox.queuedMessagesList.collapse")
    : mode === "collapsed" && queueFitsDrawer
      ? t("promptbox.queuedMessagesList.show")
      : t("promptbox.queuedMessagesList.expand");
  ...
  return (
    <PromptStackCard
      rootRef={surfaceRef}
      ariaLabel={t("promptbox.queuedMessagesList.ariaLabel")}
      ...
      >
        <div className="flex min-w-16 items-baseline gap-1.5 pl-1">
          <span className="text-xs font-medium text-foreground">
            {t("promptbox.queuedMessagesList.queuedHeader")}
          </span>
        ...
        <button
          ...
          aria-label={
            mode === "workspace"
              ? t("promptbox.queuedMessagesList.dragToDock")
              : t("promptbox.queuedMessagesList.dragToOpen")
          }
