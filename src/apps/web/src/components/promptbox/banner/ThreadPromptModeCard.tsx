...
export function ThreadPromptModeCard({
  ...
  return (
    <PromptStackCard
      ariaLabel={t("promptbox.threadPromptModeCard.ariaLabel")}
      className="overflow-hidden"
      style={{ minHeight: PROMPT_STACK_CARD_ROW_HEIGHT }}
    >
      <div
        role="group"
        aria-label={t("promptbox.threadPromptModeCard.controlsAriaLabel")}
      ...
      >
        <button
          ...
          aria-label={t("promptbox.threadPromptModeCard.plan")}
          onClick={onToggle}
        ...
        >
          ...
          >
            {t("promptbox.threadPromptModeCard.plan")}
          </span>
          <Icon
            name="ChevronDown"
            className={cn(
        ...
        {onExitPlanMode ? (
          <button
            type="button"
            aria-label={t("promptbox.threadPromptModeCard.exitPlanMode")}
        ...
        <div className="overflow-hidden bg-popover">
          <div className="px-3 pb-2.5 pt-2">
            ...
            >
              {hasPrompt
                ? promptText
                : t("promptbox.threadPromptModeCard.noPromptText")}
            </p>
          </div>
        </div>
      </section>
