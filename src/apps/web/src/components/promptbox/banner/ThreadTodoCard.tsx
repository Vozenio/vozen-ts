...
function getTodoSummary(
  ...
  return {
    visible: t("promptbox.threadTodoCard.summaryVisible", {
      completed: completedCount,
      total: items.length,
    }),
    aria: t("promptbox.threadTodoCard.summaryAria", {
      completed: completedCount,
      count: items.length,
    }),
  };
...
export function ThreadTodoCard({
  ...
  const summary = getTodoSummary(t, items);
  return (
    <PromptStackCard
      ariaLabel={t("promptbox.threadTodoCard.ariaLabel")}
    ...
    >
      <div className="flex items-center">
        <button
          ...
          aria-label={t("promptbox.threadTodoCard.toggleAriaLabel", {
            summary: summary.aria,
          })}
          onClick={onToggle}
