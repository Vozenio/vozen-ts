...
export function PromptBoxInternal({
  ...
  const placeholder =
    placeholderProp ?? t("promptbox.promptBoxInternal.defaultPlaceholder");
  const focusComposerShortcut = useAppCommandShortcut("composer.focus");
  const {
    isSubmitting = false,
    disabled: submitDisabled = false,
    disabledReason: submitDisabledReason,
    title: submitTitle = t("promptbox.promptBoxInternal.submitEnter"),
    isRunning = false,
    onStop,
    onModifierSubmit,
  } = submission;
                ...
                {onCollapse ? (
                  ...
                  >
                    <Button
                      ...
                      aria-label={t(
                        "promptbox.promptBoxInternal.collapsePromptBox",
                      )}
                      className={cn(
                      ...
                      (!showVoiceAsPrimaryAction || showStop) ? (
                        <Button
                          ...
                          aria-label={
                            !voice.isSupported
                              ? t(
                                  "promptbox.promptBoxInternal.voiceNotSupported",
                                )
                              : t("promptbox.promptBoxInternal.startVoiceInput")
                          }
                  ...
                  >
                    {showStop ? (
                      <Button
                        ...
                        size="icon"
                        variant="secondary"
                        aria-label={t("promptbox.promptBoxInternal.stopRun")}
                        onClick={onStop}
                        className={
                          showCompactLayout
                      ...
                      <Button
                        ...
                        variant="default"
                        aria-label={t(
                          "promptbox.promptBoxInternal.startVoiceInput",
                        )}
                        onPointerDown={handleVoicePointerDown}
                        onClick={startVoiceInput}
                        className={cn(
