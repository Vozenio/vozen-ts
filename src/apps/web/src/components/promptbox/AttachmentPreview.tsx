  ...
  return (
    <>
              ...
              >
                ...
                {onRemoveAttachment ? (
                  <button
                    ...
                    title={t("promptbox.attachmentPreview.remove", {
                      name: attachment.name,
                    })}
                  >
                    <Icon name="X" className="size-3" />
      ...
      <ImageLightbox
        ...
        imageAlt={
          currentAttachmentImage?.alt ??
          t("promptbox.attachmentPreview.attachedImageAlt")
        }
        title={t("promptbox.attachmentPreview.attachedImagePreviewTitle")}
