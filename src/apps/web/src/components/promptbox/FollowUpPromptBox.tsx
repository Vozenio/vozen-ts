      ...
      <PromptBoxWithScrollAnchor
        ...
        submission={{
          ...
          title: composer.isFollowUpSubmitting
            ? t("promptbox.followUpPromptBox.submitting")
            : canSubmit && composer.submitTitle !== undefined
              ? composer.submitTitle
              : canQueueFollowUp
                ? steerOnPrimarySubmit
                  ? t("promptbox.followUpPromptBox.steerCurrentRun")
                  : t("promptbox.followUpPromptBox.queueFollowUp")
                : isStopping
                  ? t("promptbox.followUpPromptBox.stoppingRun")
                  : isLoadingExecutionOptions
                    ? t("promptbox.followUpPromptBox.loadingModels")
                    : isLoadingPendingInteractions
                      ? t(
                          "promptbox.followUpPromptBox.checkingPendingInteractions",
                        )
                      : isProvisioning
                        ? t("promptbox.followUpPromptBox.provisioning")
                        : isUnavailable
                          ? t("promptbox.followUpPromptBox.unavailable")
                          : t("promptbox.followUpPromptBox.submitEnter"),
          isRunning: canStopRuntime,
        }}
        typeahead={typeahead}
