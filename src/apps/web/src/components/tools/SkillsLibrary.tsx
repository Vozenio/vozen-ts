  ...
  return (
    <>
      {routeSkillId !== undefined && hasError ? (
        <ResourceListState
          state="error"
          message={t("tools.skillsLibrary.couldntLoadSkill", "Couldn't load skill.")}
          layout="detail"
        ...
        <ResourceListState
          state="loading"
          message={t("tools.skillsLibrary.loadingSkill", "Loading skill")}
          layout="detail"
        />
      ) : routeSkillId !== undefined && selectedSkill === null ? (
        <ResourceListState
          state="empty"
          message={t("tools.skillsLibrary.skillNotFound", "Skill not found.")}
          layout="detail"
        />
      ) : selectedSkill ? (
        <SkillDetailPage
        ...
        <ResourceListState
          ...
          message={
            registryEntryQuery.isError
              ? t(
                  "tools.skillsLibrary.registrySkillLoadError",
                  "This registry skill could not be loaded.",
                )
              : t(
                  "tools.skillsLibrary.loadingRegistrySkill",
        ...
        <ResourceListState
          state="loading"
          message={t(
            "tools.skillsLibrary.checkingSkillSource",
            "Checking skill source",
          )}
          layout="detail"
        />
        ...
        <ResourceListState
          state="error"
          message={t(
            "tools.skillsLibrary.registrySkillUnavailable",
            ...
            <RegistrySkillsBrowsePage
              ...
              action={
                <CreateWithTemplatesButton
                  kind="skill"
                  label={t("tools.skillsLibrary.newBbSkill", "New vozen skill")}
