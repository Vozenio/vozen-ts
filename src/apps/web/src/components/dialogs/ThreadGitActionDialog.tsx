...
function getDialogCopy(t: TFunction, target: ThreadGitActionDialogTarget) {
  switch (target.kind) {
    case "commit":
      return {
        title: t("dialogs.threadGitAction.commit.title"),
        description: t("dialogs.threadGitAction.commit.description"),
        submitLabel: t("dialogs.threadGitAction.commit.submitLabel"),
        showMergeBase: false,
      };
    case "commit_and_squash_merge":
      return {
        title: t("dialogs.threadGitAction.commitAndSquashMerge.title"),
        description: t(
          "dialogs.threadGitAction.commitAndSquashMerge.description",
        ),
        submitLabel: t(
          "dialogs.threadGitAction.commitAndSquashMerge.submitLabel",
        ),
        showMergeBase: true,
      };
    case "squash_merge":
      return {
        title: t("dialogs.threadGitAction.squashMerge.title"),
        description: t("dialogs.threadGitAction.squashMerge.description"),
        submitLabel: t("dialogs.threadGitAction.squashMerge.submitLabel"),
        showMergeBase: true,
      };
    default:
...
export function ThreadGitActionDialog({
  ...
  const dialogCopy = useMemo(
    () => (target ? getDialogCopy(t, target) : null),
    [t, target],
  );
...
export function ThreadGitActionDialogContent({
  ...
  const dialogCopy = getDialogCopy(t, target);
  ...
  const remoteMergeBaseErrorMessage = t(
    "dialogs.threadGitAction.remoteMergeBaseError",
  );
  const missingMergeBaseErrorMessage = t(
    "dialogs.threadGitAction.missingMergeBaseError",
  );
  const checkingMergeBaseMessage = t(
    "dialogs.threadGitAction.checkingMergeBase",
  );
  ...
  const mergeBaseValidationErrorMessage = !selectedMergeBaseBranch
    ? t("dialogs.threadGitAction.mergeBaseRequired")
              ...
              <DetailRow
                label={
                  <DetailRowIconLabel icon="GitBranch">
                    {t("dialogs.threadGitAction.branchLabel")}
                  </DetailRowIconLabel>
                }
              ...
              <DetailRow
                label={
                  <DetailRowIconLabel icon="FileDiff">
                    {t("dialogs.threadGitAction.gitStatusLabel")}
                  </DetailRowIconLabel>
                }
              ...
              <DetailRow
                label={
                  <DetailRowIconLabel icon="GitMerge">
                    {t("dialogs.threadGitAction.mergeBaseLabel")}
                  </DetailRowIconLabel>
                }
                valueClassName="min-w-0"
              >
