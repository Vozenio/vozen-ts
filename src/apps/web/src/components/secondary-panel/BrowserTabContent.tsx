...
function browserPageLoadErrorTitle(
  t: TFunction,
  args: {
    errorText: string;
    url: string;
  ...
  if (isLocalOnlyUrl(args.url)) {
    return t(
      "secondaryPanel.browserTabContent.pageLoadError.serverNotReachableTitle",
      "Server not reachable",
    );
  }
  if (args.errorText.includes("ERR_BLOCKED_BY_CLIENT")) {
    return t(
      "secondaryPanel.browserTabContent.pageLoadError.pageBlockedTitle",
      "Page blocked",
    );
  }
  return t(
    "secondaryPanel.browserTabContent.pageLoadError.pageUnavailableTitle",
    "Page unavailable",
  );
}
...
function BrowserChrome({
  ...
  const addressBarLabel = t(
    "secondaryPanel.browserTabContent.chrome.addressBarLabel",
  ...
  return (
    <div
      ...
      role="region"
      aria-label={t(
        "secondaryPanel.browserTabContent.chrome.navRegionLabel",
        "Browser navigation",
      )}
      tabIndex={-1}
      className={cn(
    ...
    >
      ...
      >
        <NavButton
          icon="ChevronLeft"
          label={t("secondaryPanel.browserTabContent.chrome.goBack", "Go back")}
        ...
        <NavButton
          icon="ChevronRight"
          label={t(
            "secondaryPanel.browserTabContent.chrome.goForward",
            "Go forward",
          )}
        ...
        <NavButton
          ...
          label={
            isLoading
              ? t(
                  "secondaryPanel.browserTabContent.chrome.stopLoading",
                  "Stop loading",
                )
              : t("secondaryPanel.browserTabContent.chrome.reload", "Reload")
          }
          ...
          <div className="flex h-8 items-center gap-2 rounded-full border border-border/70 bg-background/70 px-3 max-md:pointer-coarse:h-10">
            {security === "secure" ? (
              <Icon
                ...
                aria-label={t(
                  "secondaryPanel.browserTabContent.chrome.secureConnection",
                  "Secure connection",
                )}
              />
            ) : security === "insecure" ? (
              <Icon
                ...
                aria-label={t(
                  "secondaryPanel.browserTabContent.chrome.insecureConnection",
            ...
            <input
              ...
              placeholder={t(
                "secondaryPanel.browserTabContent.chrome.addressPlaceholder",
                "Enter a URL",
              )}
              aria-label={
                locationShortcut
                  ? `${addressBarLabel} (${locationShortcut.label})`
                  : addressBarLabel
              }
        ...
        <NavButton
          icon="ExternalLink"
          label={t(
            "secondaryPanel.browserTabContent.chrome.openInExternalBrowser",
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-3 px-6 text-center">
      ...
      <div className="text-sm font-medium text-foreground">
        {t(
          "secondaryPanel.browserTabContent.unavailable.title",
      ...
      >
        {t(
          "secondaryPanel.browserTabContent.unavailable.description",
...
function BrowserPageLoadError({
  ...
  const title = browserPageLoadErrorTitle(t, { errorText, url });
  const message = isLocalOnlyUrl(url)
    ? t(
        "secondaryPanel.browserTabContent.pageLoadError.unreachableMessage",
        "The browser could not reach {{host}}. Start the server, then reload.",
        {
          host:
            host ||
            t(
              "secondaryPanel.browserTabContent.pageLoadError.thisLocalServer",
              "this local server",
            ),
        },
      )
    : t(
        "secondaryPanel.browserTabContent.pageLoadError.genericMessage",
      ...
      <div className="flex w-full max-w-sm flex-col items-center gap-3">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 pt-1">
          ...
          >
            ...
            {t("secondaryPanel.browserTabContent.pageLoadError.reload", "Reload")}
          </button>
          <button
            type="button"
            onClick={onOpenExternal}
          ...
          >
            ...
            {t(
              "secondaryPanel.browserTabContent.pageLoadError.openExternally",
              "Open externally",
            )}
          </button>
        </div>
