    ...
    <div className="flex h-full flex-col overflow-y-auto px-4 pb-6 pt-8">
      <div className="mx-auto flex w-full max-w-xl flex-col gap-6">
        <section>
          <LauncherSectionHeader
            label={t(
              "secondaryPanel.browserNewTabScreen.recentlyVisited",
              "Recently visited",
            )}
            count={recent.length}
            action={
              <button
                ...
                aria-label={t(
                  "secondaryPanel.browserNewTabScreen.clearRecentlyVisited",
              ...
              >
                {t("secondaryPanel.browserNewTabScreen.clear", "Clear")}
              </button>
            }
          />
          <ul
