...
function splitZoneLabel(zone: SplitSide, t: TFunction): string {
  switch (zone) {
    case "left":
      return t("secondaryPanel.sidebarSplitContainer.splitLeft", "Split left");
    case "right":
      return t(
        "secondaryPanel.sidebarSplitContainer.splitRight",
        "Split right",
      );
    case "top":
      return t("secondaryPanel.sidebarSplitContainer.splitTop", "Split top");
    case "bottom":
      return t(
        "secondaryPanel.sidebarSplitContainer.splitBottom",
        "Split bottom",
      );
  }
}
  ...
  const beginTabDrag = useCallback(
    (
      ...
      const label =
        ...
        t(
          "secondaryPanel.sidebarSplitContainer.panelTabFallback",
          "Panel tab",
        );
      beginSplitDrag({
        ghostLabel: label,
        ...
        decide: (targetPaneId, zone) => {
          ...
          return {
            ...
            label:
              zone === "center"
                ? t(
                    "secondaryPanel.sidebarSplitContainer.groupTabHere",
                    "Group tab here",
                  )
                : splitZoneLabel(zone, t),
          };
        },
        onDrop: (target) => moveTab(sourcePaneId, tabId, target),
      });
    },
    [moveTab, state, t, tabs],
  );
  ...
  return (
    <div
      ...
      aria-label={
        horizontal
          ? t(
              "secondaryPanel.sidebarSplitContainer.resizeHorizontal",
              "Resize right panel panes",
            )
          : t(
              "secondaryPanel.sidebarSplitContainer.resizeVertical",
