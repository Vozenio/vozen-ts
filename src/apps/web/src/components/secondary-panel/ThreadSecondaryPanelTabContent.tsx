        ...
        <div className="rounded-lg border border-surface-destructive-border bg-surface-destructive px-3 py-2 text-xs text-destructive">
          <p>
            {diffFilesError instanceof Error
              ...
              : t(
                  "secondaryPanel.tabContent.gitDiff.loadError",
    ...
    return (
      <div className={cn(PANEL_SCROLL_SLOT_CLASS, "px-4 pb-3")}>
        <EmptyStatePanel className="rounded-lg">
          {t(
            "secondaryPanel.tabContent.gitDiff.noDiffToDisplay",
            "No diff to display.",
          )}
        </EmptyStatePanel>
      </div>
      ...
      <div className={cn(PANEL_SCROLL_SLOT_CLASS, "px-4 pb-3")}>
        <div className="rounded-lg border border-border bg-surface-raised px-3 py-2 text-xs text-muted-foreground">
          <p className="font-medium text-foreground">
            {t(
              "secondaryPanel.tabContent.gitDiff.workspaceUnavailable",
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {diffFilesResponse.truncated ? (
        ...
        >
          {t(
            "secondaryPanel.tabContent.gitDiff.truncatedBanner",
            "Showing the first {{count}} changed files. Additional changes are omitted.",
            { count: diffFilesResponse.files.length },
          )}
        </div>
      ) : null}
      <DiffFilesPanel
