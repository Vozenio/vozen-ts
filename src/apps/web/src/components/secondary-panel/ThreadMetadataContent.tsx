    ...
    <DetailRow
      label={
        <DetailRowIconLabel icon="UserRound">
          {t("secondaryPanel.threadMetadataContent.parent.label", "Parent")}
        </DetailRowIconLabel>
      }
    ...
    >
      {parentThreadId ? (
        ...
        >
          ...
          >
            {selectedParentOptionLabel ??
              t(
                "secondaryPanel.threadMetadataContent.parent.fallbackThreadLabel",
                "Parent thread",
              )}
          </Link>
          <Button
            ...
            aria-label={t(
              "secondaryPanel.threadMetadataContent.parent.clearAriaLabel",
              "Clear parent thread",
            )}
          >
            <Icon name="X" />
        ...
        >
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              >
                {selectedParentOptionLabel ??
                  t(
                    "secondaryPanel.threadMetadataContent.parent.noneLabel",
                    "None",
                  )}
              </span>
              <Icon
          ...
          <DropdownMenuContent align="start" className="min-w-40 max-w-72">
            <DropdownMenuLabel>
              {t(
                "secondaryPanel.threadMetadataContent.parent.assignMenuLabel",
            ...
            {isLoadingParentThreads ? (
              <DropdownMenuItem disabled>
                {t(
                  "secondaryPanel.threadMetadataContent.parent.loadingThreads",
                  "Loading threads…",
                )}
              </DropdownMenuItem>
            ) : isParentThreadsError ? (
              <DropdownMenuItem onSelect={onRetryParentThreads}>
                {t(
                  "secondaryPanel.threadMetadataContent.parent.retryLoadingThreads",
...
function ForksRow({ thread, projectId }: ForksRowProps) {
  ...
  return (
    <DetailRow
      label={t("secondaryPanel.threadMetadataContent.forks.label", "Forks")}
      align="start"
      valueClassName="min-w-0"
    >
      <TruncatedList
...
export function EnvironmentRow({
  ...
  const createThreadInWorktreeLabel = t(
    "secondaryPanel.threadMetadataContent.environment.createThreadInWorktree",
  ...
  return (
    <DetailRow
      label={
        ...
        >
          {t("secondaryPanel.threadMetadataContent.environment.label", "Environment")}
        </DetailRowIconLabel>
      }
      valueClassName="min-w-0"
    >
        ...
        {environmentDisplayHost.identity ? (
          <span
            ...
            title={
              environmentDisplayHost.identity.connected
                ? t(
                    "secondaryPanel.threadMetadataContent.environment.hostTitleConnected",
                    "On {{name}} (connected)",
                    { name: environmentDisplayHost.identity.name },
                  )
                : t(
                    "secondaryPanel.threadMetadataContent.environment.hostTitleOffline",
                    "On {{name}} (offline)",
                    { name: environmentDisplayHost.identity.name },
                  )
            }
          >
            ...
            {environmentDisplayHost.identity.connected
              ? ""
              : t(
                  "secondaryPanel.threadMetadataContent.environment.offlineSuffix",
                  " (offline)",
                )}
          </span>
        ) : null}
        {showCreateThreadButton ? (
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                type="button"
                aria-label={createThreadInWorktreeLabel}
            ...
            <TooltipContent>{createThreadInWorktreeLabel}</TooltipContent>
          </Tooltip>
        ) : null}
      </span>
    </DetailRow>
  ...
  return (
    <DetailRow
      label={
        <DetailRowIconLabel icon="Folder">
          {t(
            "secondaryPanel.threadMetadataContent.workspacePath.label",
            "Directory",
          )}
        </DetailRowIconLabel>
      }
    ...
    >
      <CopyableInlineLabel
        ...
        label={t(
          "secondaryPanel.threadMetadataContent.workspacePath.copyLabel",
          "Copy directory",
        )}
        title={environment.path}
        successMessage={t(
          "secondaryPanel.threadMetadataContent.workspacePath.copySuccess",
          "Directory copied",
        )}
        errorMessage={t(
          "secondaryPanel.threadMetadataContent.workspacePath.copyError",
    ...
    >
      {checkoutDisplay.copyValue !== null ? (
        <CopyableInlineLabel
          ...
          label={
            checkoutDisplay.copyLabel ??
            t(
              "secondaryPanel.threadMetadataContent.branch.copyValueFallbackLabel",
              "Copy checkout value",
            )
          }
          title={checkoutDisplay.title}
          successMessage={
            checkoutDisplay.copySuccessMessage ??
            t(
              "secondaryPanel.threadMetadataContent.branch.copySuccessFallback",
              "Value copied",
            )
          }
          errorMessage={
            checkoutDisplay.copyErrorMessage ??
            t(
              "secondaryPanel.threadMetadataContent.branch.copyErrorFallback",
  ...
  return (
    <DetailRow
      label={
        <DetailRowIconLabel icon="GitPullRequestArrow">
          {t(
            "secondaryPanel.threadMetadataContent.pullRequest.label",
            "Pull request",
          )}
        </DetailRowIconLabel>
      }
    ...
    >
      <a
        ...
        aria-label={t(
          "secondaryPanel.threadMetadataContent.pullRequest.ariaLabel",
          "Pull request {{number}}: {{label}}",
          { number: pullRequest.number, label: attentionDisplay.label },
        )}
    ...
    <DetailRow
      label={
        <DetailRowIconLabel icon="GitMerge">
          {t(
            "secondaryPanel.threadMetadataContent.mergeBase.label",
            "Merge base",
          )}
        </DetailRowIconLabel>
      }
    ...
    <DetailRow
      label={
        <DetailRowIconLabel icon="FileDiff">
          {t(
            "secondaryPanel.threadMetadataContent.gitStatus.label",
            "Git status",
          )}
        </DetailRowIconLabel>
      }
...
export function ArchivedRow({ thread }: ArchivedRowProps) {
  ...
  return (
    <DetailRow
      label={t("secondaryPanel.threadMetadataContent.archived.label", "Archived")}
      valueClassName="min-w-0 truncate"
    >
  ...
  return (
    <div className="flex min-w-0 items-center justify-between gap-2">
      ...
      <button
        type="button"
        aria-label={t(
          "secondaryPanel.threadMetadataContent.commits.copyShaAriaLabel",
          "Copy commit {{shortSha}} SHA",
        ...
        onClick={() => {
          void copyToClipboardWithToast(commit.sha, {
            successMessage: t(
              "secondaryPanel.threadMetadataContent.commits.copySuccess",
              "Commit SHA copied",
            ),
            errorMessage: t(
              "secondaryPanel.threadMetadataContent.commits.copyError",
              "Failed to copy commit SHA",
            ),
          });
        }}
      >
...
export function ThreadCommitsRow({
  ...
  return (
    <>
      ...
      <DetailRow
        label={t("secondaryPanel.threadMetadataContent.commits.label", "Commits")}
    ...
    <DetailRow
      ...
      label={
        <>
          <span>
            {t(
              "secondaryPanel.threadMetadataContent.storage.label",
              "Thread storage",
            )}
          </span>
          {isSearchOpen ? null : (
            <Button
              ...
              aria-label={t(
                "secondaryPanel.threadMetadataContent.storage.searchAriaLabel",
                "Search files",
              )}
              onClick={openSearch}
            >
