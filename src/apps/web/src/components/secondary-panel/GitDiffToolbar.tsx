...
export function GitDiffToolbar({
  ...
  const truncatedFilesLabel =
    stats.filesCount === 1
      ? t(
          "secondaryPanel.gitDiffToolbar.truncatedFilesLabel.one",
          "{{count}}+ file",
          { count: stats.filesCount },
        )
      : t(
          "secondaryPanel.gitDiffToolbar.truncatedFilesLabel.other",
          "{{count}}+ files",
          { count: stats.filesCount },
        );
  const hasShownLineChanges = stats.insertions > 0 || stats.deletions > 0;
  const truncatedSummaryTitle = t(
    "secondaryPanel.gitDiffToolbar.truncatedSummaryTitle.template",
    "Showing the first {{filesCount}} changed {{fileWord}}; shown slice: {{insertions}} {{insertionWord}}, {{deletions}} {{deletionWord}}",
    {
      ...
      fileWord:
        stats.filesCount === 1
          ? t(
              "secondaryPanel.gitDiffToolbar.truncatedSummaryTitle.fileWord.one",
              "file",
            )
          : t(
              "secondaryPanel.gitDiffToolbar.truncatedSummaryTitle.fileWord.other",
              "files",
            ),
      ...
      insertionWord:
        stats.insertions === 1
          ? t(
              "secondaryPanel.gitDiffToolbar.truncatedSummaryTitle.insertionWord.one",
              "insertion",
            )
          : t(
              "secondaryPanel.gitDiffToolbar.truncatedSummaryTitle.insertionWord.other",
              "insertions",
            ),
      ...
      deletionWord:
        stats.deletions === 1
          ? t(
              "secondaryPanel.gitDiffToolbar.truncatedSummaryTitle.deletionWord.one",
              "deletion",
            )
          : t(
              "secondaryPanel.gitDiffToolbar.truncatedSummaryTitle.deletionWord.other",
              "deletions",
            ),
    },
  );
      ...
      >
        ...
        >
          <span
            ...
            title={isTruncated ? truncatedSummaryTitle : completeSummary}
          >
            {isTruncated ? (
              <>
                {truncatedFilesLabel}
                {hasShownLineChanges ? (
                  <>
                    {t(
                      "secondaryPanel.gitDiffToolbar.shownSeparator",
                      " · shown ",
                    )}
                    <DiffStatsTally
                      insertions={stats.insertions}
          ...
          >
            <Button
              ...
              aria-label={
                areAllFilesCollapsed
                  ? t(
                      "secondaryPanel.gitDiffToolbar.expandAllFilesLabel",
                      "Expand all files",
                    )
                  : t(
                      "secondaryPanel.gitDiffToolbar.collapseAllFilesLabel",
                      "Collapse all files",
                    )
              }
            >
            ...
            <Button
              ...
              aria-label={
                lineOverflowMode === "wrap"
                  ? t(
                      "secondaryPanel.gitDiffToolbar.disableLineWrapLabel",
                      "Disable diff line wrap",
                    )
                  : t(
                      "secondaryPanel.gitDiffToolbar.wrapLinesLabel",
                      "Wrap diff lines",
                    )
              }
            ...
            <div
              ...
              role="tablist"
              aria-label={t(
                "secondaryPanel.gitDiffToolbar.diffViewModeGroupLabel",
                "Diff view mode",
              )}
            >
              <Button
                ...
                aria-label={t(
                  "secondaryPanel.gitDiffToolbar.stackedDiffViewLabel",
                  "Stacked diff view",
                )}
              ...
              <Button
                ...
                aria-label={t(
                  "secondaryPanel.gitDiffToolbar.splitDiffViewLabel",
                  "Split diff view",
                )}
