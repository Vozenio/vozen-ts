...
export function ThreadStorageBrowser({
  ...
  const loadingState = (
    <EmptyState
      icon="Spinner"
      message={t(
        "secondaryPanel.threadStorageBrowser.loadingFiles",
        "Loading files...",
      )}
  ...
  if (filesError) {
      ...
      <EmptyState
        message={
          ...
          getMutationErrorMessage({
            error: filesError,
            fallbackMessage: t(
              "secondaryPanel.threadStorageBrowser.failedToLoad",
    ...
    body = (
      <EmptyState
        message={t(
          "secondaryPanel.threadStorageBrowser.noFilesYet",
          "No files yet.",
        )}
      />
    );
    ...
    body = (
      <EmptyState
        message={t(
          "secondaryPanel.threadStorageBrowser.noFilesMatchSearch",
        ...
        <div className="flex h-7 shrink-0 items-center gap-2 max-md:pointer-coarse:h-10">
          <div className="relative min-w-0 flex-1">
            ...
            <Input
              ref={searchInputRef}
              aria-label={t(
                "secondaryPanel.threadStorageBrowser.searchFiles",
                "Search files",
              )}
              className={cn(
          ...
          <Button
            ...
            aria-label={t(
              "secondaryPanel.threadStorageBrowser.closeSearch",
              "Close search",
            )}
            onClick={closeSearch}
          >
