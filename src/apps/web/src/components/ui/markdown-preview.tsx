        ...
        <div className="flex items-center justify-between pl-3 pr-1.5 pt-1.5">
          ...
          <div className="flex items-center gap-0.5">
            <button
              ...
              aria-label={
                softWrap
                  ? t("ui.markdownPreview.disableLineWrap")
                  : t("ui.markdownPreview.wrapLongLines")
              }
              onClick={() => {
            ...
            <CopyButton text={codeText} label={t("ui.markdownPreview.copyCode")} />
          </div>
        </div>
        <pre
          className={cn(
...
function renderMarkdownImage({
  ...
  return (
    <img
      {...imageAttributes}
      src={imageUrl}
      alt={typeof alt === "string" ? alt : t("ui.markdownPreview.image")}
    ...
    if (imagePolicy === "alt-text") {
      return (
        <span data-markdown-image-fallback="">
          {t("ui.markdownPreview.imageBracketTemplate", {
            alt:
              typeof alt === "string" && alt.length > 0
                ? alt
                : t("ui.markdownPreview.imageAltTextFallback"),
          })}
        </span>
      );
    }
  ...
  return (
    <>
      ...
      <ImageLightbox
        ...
        imageAlt={t("ui.markdownPreview.expandedImage")}
        title={t("ui.markdownPreview.expandedImagePreview")}
