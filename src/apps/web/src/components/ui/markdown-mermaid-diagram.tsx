    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex h-[min(84dvh,58rem)] w-full max-w-none gap-0 overflow-hidden border-border bg-background p-0 shadow-sm md:w-[min(96vw,88rem)] [&>button]:right-2 [&>button]:top-2 [&>button]:z-20 [&>button]:flex [&>button]:size-8 [&>button]:items-center [&>button]:justify-center [&>button]:rounded-md [&>button]:bg-surface-scrim/95 [&>button]:text-muted-foreground [&>button]:opacity-100 [&>button]:backdrop-blur-sm [&>button]:hover:bg-state-hover [&>button]:hover:text-foreground">
        <DialogTitle className="sr-only">
          {t("ui.mermaidDiagram.diagramLabel")}
        </DialogTitle>
        <DialogDescription className="sr-only">
          {t("ui.mermaidDiagram.description")}
        </DialogDescription>
        <div className="absolute right-2 top-8 z-10 flex h-8 items-center gap-1 rounded-md bg-surface-scrim/95 p-0.5 backdrop-blur-sm md:right-11 md:top-2">
          <Button
            ...
            onClick={zoomOut}
            aria-label={t("ui.mermaidDiagram.zoomOut")}
          >
            <Icon name="ZoomOut" />
          </Button>
          <Button
            ...
            className="size-7 text-muted-foreground"
            onClick={zoomIn}
            aria-label={t("ui.mermaidDiagram.zoomIn")}
          >
            <Icon name="ZoomIn" />
          </Button>
          <Button
            ...
            className="size-7 text-muted-foreground"
            onClick={resetView}
            aria-label={t("ui.mermaidDiagram.resetView")}
          >
            <Icon name="RotateCcw" />
          </Button>
          <CopyButton
            text={source}
            label={t("ui.mermaidDiagram.copySource")}
        ...
        >
          <div className="flex h-full w-full items-center justify-center p-6">
            <div
              ...
              role="img"
              aria-label={t("ui.mermaidDiagram.diagramLabel")}
              style={diagramStyle}
        ...
        <div className="flex items-center gap-1">
          {isRendered ? (
            <Button
              ...
              aria-label={t("ui.mermaidDiagram.showSource")}
          ...
          {isRendered ? (
            <Button
              ...
              aria-label={t("ui.mermaidDiagram.openDiagram")}
            >
              <Icon name="Maximize2" />
            </Button>
          ) : null}
          <CopyButton text={source} label={t("ui.mermaidDiagram.copySource")} />
        </div>
      </div>
      {showRenderedDiagram ? (
