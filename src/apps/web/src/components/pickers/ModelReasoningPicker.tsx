...
export function ModelReasoningPicker({
  ...
  const selectedModelLoadErrorText =
    selectedModelLoadErrorMatches && modelLoadError
      ...
      : t("ui.modelReasoningPicker.couldNotLoadModels");
  ...
  const triggerModelLabel = modelIsLoading
    ? t("ui.modelReasoningPicker.loadingModelsEllipsis")
    : hasSelectedModel
      ? stripModelBrandPrefix(selectedModelLabel, selectedProvider?.brandPrefix)
      : selectedModelLoadFailed
        ? hasAlternateSelectionPath
          ? t("ui.modelReasoningPicker.selectModel")
          : t("ui.modelReasoningPicker.failedToLoad")
        : modelOptions.length === 0
          ? canSwitchProviders
            ? t("ui.modelReasoningPicker.selectModel")
            : t("ui.modelReasoningPicker.noModelsAvailable")
          : t("ui.modelReasoningPicker.selectModel");
  const triggerModelValueIsDestructive =
    triggerModelLabel === t("ui.modelReasoningPicker.failedToLoad");
  ...
  const effectiveFastModeLabel = isPreviewing
    ...
    : (fastModeLabel ?? t("ui.modelReasoningPicker.fastDefault"));
  const fastModeText = t("ui.modelReasoningPicker.fastModeText", {
    label: effectiveFastModeLabel,
  });
  ...
  const triggerTitle = [
    ...
    triggerReasoningLabel
      ? t("ui.modelReasoningPicker.reasoningSuffix", {
          label: triggerReasoningLabel,
        })
      : "",
    showSelectedFastMode
      ? t("ui.modelReasoningPicker.fastModeParenSuffix")
      : "",
  ].join("");
  ...
  const trigger = (
    <Button
      ...
      aria-label={
        toggleShortcut
          ? t("ui.modelReasoningPicker.ariaProviderModelReasoningWithShortcut", {
              shortcut: toggleShortcut.label,
            })
          : t("ui.modelReasoningPicker.ariaProviderModelReasoning")
      }
        ...
        {modelIsLoading ? (
          <>
            ...
            <span className="sr-only">
              {t("ui.modelReasoningPicker.loadingModelsAria")}
            </span>
            <Skeleton
              aria-hidden
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      ...
      <PopoverContent
        align={align}
        mobileTitle={t("ui.modelReasoningPicker.model")}
        ...
        <MenuHoverProvider>
          ...
          >
            ...
            <div
              ...
              aria-label={
                showSearchInput
                  ? t("ui.modelReasoningPicker.ariaModels")
                  : undefined
              }
              className={cn(
                "px-1 pb-1 pt-0",
            ...
            >
              {isShowingModelError ? null : (
                <MenuSectionLabel>
                  {t("ui.modelReasoningPicker.model")}
                </MenuSectionLabel>
              )}
              {activeModelIsLoading ? (
                ...
                <>
                  ...
                  {isSearching && navRows.length === 0 ? (
                    ...
                    >
                      {t("ui.modelReasoningPicker.noModelsMatchSearch")}
                    </div>
                  ) : null}
                </>
              ) : (
            ...
            {showReasoningSection ? (
              <>
                ...
                <div className="px-1 pb-1 pt-0">
                  <MenuSectionLabel>
                    {t("ui.modelReasoningPicker.reasoning")}
                  </MenuSectionLabel>
...
function ModelPickerLoadingRows() {
  ...
  return (
    <div
      role="status"
      aria-label={t("ui.modelReasoningPicker.loadingModelsAria")}
      className="pb-1"
    >
      <span className="sr-only">
        {t("ui.modelReasoningPicker.loadingModelsAria")}
...
function MoreModelsToggleRow({
  ...
  return (
    ...
    >
      <span>
        {expanded
          ? t("ui.modelReasoningPicker.fewerModels")
          : t("ui.modelReasoningPicker.moreModels")}
      </span>
      <Icon
  ...
  return (
    <Popover open={open} onOpenChange={onOpenChange}>
      <PopoverAnchor asChild>
        ...
        >
          <span>{t("ui.modelReasoningPicker.moreModels")}</span>
    ...
    <div className="shrink-0 border-b border-border px-1.5 py-1">
      <div className="relative">
        ...
        <Input
          ...
          onKeyDown={onKeyDown}
          placeholder={t("ui.modelReasoningPicker.searchModelsPlaceholder")}
          aria-label={t("ui.modelReasoningPicker.searchModelsPlaceholder")}
          role="combobox"
          aria-expanded
