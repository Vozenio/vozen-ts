    ...
    <DropdownMenu modal={modal}>
      <DropdownMenuTrigger asChild disabled={disabled}>
        <Button
          ...
          variant="ghost"
          size="sm"
          aria-label={t("ui.machinePicker.machine")}
          disabled={disabled}
        ...
        >
          <span className={OPTION_TRIGGER_CONTENT_CLASS_NAME}>
            ...
            <span className="min-w-0 truncate">
              {selectedHost?.name ?? t("ui.machinePicker.machine")}
            </span>
          </span>
          {disabled ? null : (
            <Icon
      ...
      <DropdownMenuContent
        ...
        mobileTitle={t("ui.machinePicker.machine")}
      >
              ...
              <span className="flex min-w-0 flex-1 items-center gap-1.5">
                ...
                {host.id === localDaemonHostId ? (
                  <span className={MACHINE_BADGE_CLASS_NAME}>
                    {t("ui.machinePicker.thisMachine")}
                  </span>
                ) : null}
              </span>
