      ...
      <DropdownMenu onOpenChange={onOpenChange}>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            variant="ghost"
            size="icon"
            aria-label={t("sidebar.worktree.actions")}
            className={cn(
...
function EnvironmentThreadGroupHeader({
  ...
  const displayName =
    environmentName || branchName || t("sidebar.worktree.default");
    ...
    <>
      ...
      <span className="pointer-events-none relative z-10 flex min-w-0 flex-1 items-center gap-1.5 text-left text-subtle-foreground/80">
        ...
        <SidebarChildToggleChevron
          ...
          expandLabel={t("sidebar.worktree.expandThreads", {
            name: displayName,
          })}
          collapseLabel={t("sidebar.worktree.collapseThreads", {
            name: displayName,
          })}
      ...
      <>
          ...
          <DropdownMenu onOpenChange={setIsTopLevelActionsOpen}>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                variant="ghost"
                size="icon"
                aria-label={t("sidebar.section.sectionActions", {
                  label: section.name,
                })}
                className={cn(
        ...
        {onCreateThreadInSection ? (
          <Button
            ...
            variant="ghost"
            size="icon"
            aria-label={t("sidebar.section.newThreadIn", {
              name: section.name,
            })}
      ...
      <EmptyState
        message={
          threadListState.status === "unavailable"
            ? t("sidebar.section.threadsUnavailable")
            : t("sidebar.section.noThreads")
        }
    ...
    <>
      ...
      {isLocalPathInvalid ? (
        <NavLink
          ...
          aria-label={t("sidebar.project.folderNotFound")}
          className={cn(
