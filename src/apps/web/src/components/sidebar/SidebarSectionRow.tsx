    ...
    <>
      ...
      <span className="relative z-10 flex min-w-0 flex-1 items-center gap-1 text-left">
        ...
        <SidebarChildToggleChevron
          ...
          expandLabel={t("sidebar.section.expandSection", { label })}
          collapseLabel={t("sidebar.section.collapseSection", { label })}
              ...
              <DropdownMenu onOpenChange={setIsActionsOpen}>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    variant="ghost"
                    size="icon"
                    aria-label={t("sidebar.section.sectionActions", { label })}
                    className={cn(
