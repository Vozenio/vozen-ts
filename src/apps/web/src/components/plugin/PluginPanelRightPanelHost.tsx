...
export function PluginPanelRightPanelHost({
        ...
        switch (tab.kind) {
            ...
            return [
              {
                ...
                label:
                  label ||
                  t("plugin.panelRightPanelHost.tabs.browser.fallbackLabel"),
            ...
            return [
              {
                ...
                label:
                  session?.title ??
                  t("plugin.panelRightPanelHost.tabs.terminal.fallbackLabel"),
          ...
          case "new-tab":
            return [
              {
                ...shared,
                label: t("plugin.panelRightPanelHost.tabs.newTab.label"),
  ...
  const toggleLabel = isOpen
    ? t("plugin.panelRightPanelHost.toggle.hideLabel")
    : t("plugin.panelRightPanelHost.toggle.showLabel");
  ...
  const page = (
    ...
    >
      <SecondaryPanelLayout
        ...
        drawerLabel={t("plugin.panelRightPanelHost.drawerLabel")}
        drawerFallback={null}
