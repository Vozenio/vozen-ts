...
const ARCHETYPE_SOURCE: readonly Omit<BrowseArchetype, "id">[] = [
  ...
  },
  {
    ...
    hook: "Put the numbers your team actually checks on the vozen homepage.",
...
export const UTILITY_EXAMPLES: readonly UtilityExample[] = [
  ...
  },
  {
    ...
    icon: "Terminal",
    brief:
      "adds a vozen CLI command that deploys the current branch to staging and reports status",
  },
  {
