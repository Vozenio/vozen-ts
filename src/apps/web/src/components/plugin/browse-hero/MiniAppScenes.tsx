...
function KanbanScene({ accentToken }: SceneProps) {
  ...
  const columns = [
    { label: t("plugin.browseHero.miniAppScenes.kanban.columns.todo"), cards: 3 },
    {
      label: t("plugin.browseHero.miniAppScenes.kanban.columns.inProgress"),
      cards: 2,
      active: true,
    },
    { label: t("plugin.browseHero.miniAppScenes.kanban.columns.review"), cards: 2 },
  ];
  return (
...
function DashboardScene({ accentToken }: SceneProps) {
  ...
  const stats = [
    { label: t("plugin.browseHero.miniAppScenes.dashboard.stats.deploys"), value: "18" },
    { label: t("plugin.browseHero.miniAppScenes.dashboard.stats.openPRs"), value: "7" },
    { label: t("plugin.browseHero.miniAppScenes.dashboard.stats.ciPass"), value: "96%" },
  ];
  return (
    <div className="flex h-full flex-col gap-2 p-2">
      ...
      <SceneCard className="flex min-h-0 flex-1 flex-col gap-1.5">
        <SceneLabel>{t("plugin.browseHero.miniAppScenes.dashboard.throughput")}</SceneLabel>
...
function VideoEditorScene({ accentToken }: SceneProps) {
  ...
  const tracks = [
    {
      id: "video",
      label: t("plugin.browseHero.miniAppScenes.videoEditor.tracks.video"),
      height: "h-3.5",
      clips: [
    ...
    {
      id: "audio",
      label: t("plugin.browseHero.miniAppScenes.videoEditor.tracks.audio"),
      height: "h-2",
      clips: [
    ...
    {
      id: "captions",
      label: t("plugin.browseHero.miniAppScenes.videoEditor.tracks.captions"),
      height: "h-1.5",
      clips: [
        { width: "16%", active: false },
  ...
  return (
    <div className="flex h-full flex-col gap-1.5 p-2">
      <div className="flex items-center gap-1">
        <SceneLabel>
          {t("plugin.browseHero.miniAppScenes.videoEditor.launchVideo")}
        </SceneLabel>
        <span
        ...
        >
          {t("plugin.browseHero.miniAppScenes.videoEditor.firstCutTimestamp")}
        </span>
      </div>
                    ...
                    background:
                      track.id === "audio"
                        ...
                        : clip.active
                          ...
                          : neutral(track.id === "captions" ? 16 : 12),
                  }}
                />
              ))}
            </div>
      ...
      >
        <span className="text-2xs" style={{ color: neutral(46) }}>
          {t("plugin.browseHero.miniAppScenes.videoEditor.captionsAndMusicAdded")}
        </span>
        <span
          className="text-2xs font-medium"
          style={{ color: accentInk(accentToken, 62) }}
        >
          {t("plugin.browseHero.miniAppScenes.videoEditor.renderingFirstCut")}
        </span>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex h-full flex-col gap-1.5 p-2">
      <div className="flex items-center justify-between">
        <SceneLabel>
          {t("plugin.browseHero.miniAppScenes.chiefOfStaff.workingForYou")}
        </SceneLabel>
        <span
        ...
        >
          {t("plugin.browseHero.miniAppScenes.chiefOfStaff.runningCount")}
        </span>
      </div>
      {lanes.map((lane) => (
        <SceneCard key={lane.worktree} className="flex flex-col gap-1">
          <div className="flex items-center gap-1">
            ...
            {lane.blocked ? (
              ...
              >
                {t("plugin.browseHero.miniAppScenes.chiefOfStaff.needsYou")}
              </span>
            ) : (
              <span
              ...
              >
                {lane.agents}{" "}
                {t("plugin.browseHero.miniAppScenes.chiefOfStaff.agentsSuffix")}
              </span>
            )}
          </div>
...
function PrototypingLabScene({ accentToken }: SceneProps) {
  ...
  const prototypes = [
    {
      id: "guided",
      name: t("plugin.browseHero.miniAppScenes.prototypingLab.names.guided"),
      state: "ready",
    },
    {
      id: "onePage",
      name: t("plugin.browseHero.miniAppScenes.prototypingLab.names.onePage"),
      state: "ready",
    },
    {
      id: "express",
      name: t("plugin.browseHero.miniAppScenes.prototypingLab.names.express"),
      state: "building",
    },
  ];
  return (
    <div className="flex h-full flex-col gap-1.5 p-2">
      <div className="flex items-center gap-1.5">
        <SceneLabel>
          {t("plugin.browseHero.miniAppScenes.prototypingLab.checkoutFlow")}
        </SceneLabel>
        <span
        ...
        >
          {t("plugin.browseHero.miniAppScenes.prototypingLab.prototypesCount")}
        </span>
      </div>
        ...
        {prototypes.map((prototype, index) => {
          ...
          return (
            ...
            >
              ...
              <SceneLabel>
                {ready
                  ? t("plugin.browseHero.miniAppScenes.prototypingLab.state.ready")
                  : t(
                      "plugin.browseHero.miniAppScenes.prototypingLab.state.building",
                    )}
              </SceneLabel>
      ...
      >
        <span className="text-2xs" style={{ color: neutral(46) }}>
          {t("plugin.browseHero.miniAppScenes.prototypingLab.readyCount")}
        </span>
        <span
          className="text-2xs font-medium"
          style={{ color: accentInk(accentToken, 62) }}
        >
          {t("plugin.browseHero.miniAppScenes.prototypingLab.compareSideBySide")}
        </span>
      </div>
    </div>
  );
...
function InboxScene({ accentToken }: SceneProps) {
  ...
  const kindLabels: Record<string, string> = {
    bug: t("plugin.browseHero.miniAppScenes.inbox.kind.bug"),
    question: t("plugin.browseHero.miniAppScenes.inbox.kind.question"),
  };
  return (
    <div className="flex h-full flex-col gap-1.5 p-2">
      <div className="flex items-center gap-1">
        <SceneLabel>{t("plugin.browseHero.miniAppScenes.inbox.title")}</SceneLabel>
        <span
        ...
        >
          {t("plugin.browseHero.miniAppScenes.inbox.openCount")}
        </span>
      </div>
      {rows.map((row, index) => (
        <SceneCard
      ...
      >
        <span className="font-mono text-2xs" style={{ color: neutral(46) }}>
          {t("plugin.browseHero.miniAppScenes.inbox.replyDrafted")}
        </span>
        <span
          className="text-2xs font-medium"
          style={{ color: accentInk(accentToken, 62) }}
        >
          {t("plugin.browseHero.miniAppScenes.inbox.fixThreadOpened")}
        </span>
      </div>
    </div>
  );
