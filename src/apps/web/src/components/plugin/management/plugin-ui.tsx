...
export function FullTrustWarning() {
  ...
  return (
    ...
    >
      ...
      <span>
        {t(
          "plugin.management.ui.fullTrustWarning",
          "Plugins run as full-trust code with access to your computer. Only install from sources you trust.",
        )}
      </span>
    </p>
  );
...
export function RollbackNote({
  ...
  return (
    ...
    >
      ...
      <span>
        {t(
          "plugin.management.ui.rollbackNote",
          "Your plugin data is snapshotted first — if {{toVersion}} fails to start, vozen restores {{fromVersion}} and its data automatically.",
