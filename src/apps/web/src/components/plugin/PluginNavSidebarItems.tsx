    ...
    return [
      {
        ...
        pluginId: BUILTIN_NAV_ROW_PLUGIN_ID,
        id: "tools",
        title: t("plugin.navSidebarItems.extensionsRow.title"),
        routePath: toolsRoutePath,
      },
      ...pluginRows,
    ];
  }, [navPanels, t, toolsRoutePath]);
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 truncate text-left">
        {t("plugin.navSidebarItems.overflowToggle.label", { count })}
      </span>
    </Button>
  );
}
...
function PluginNavRowVisibilityMenuItem({
  ...
  const content = (
    <>
      ...
      {isHidden
        ? t("plugin.navSidebarItems.visibilityMenuItem.show")
        : t("plugin.navSidebarItems.visibilityMenuItem.hide")}
    </>
  );
...
function SidebarNavRowChrome({
  ...
  return (
    <ContextMenu onOpenChange={setIsActionsOpen}>
          ...
          >
            ...
            <span className="flex min-w-0 flex-1 items-center gap-1.5 text-left">
              ...
              {splitMiniMap ? (
                <SplitPaneMiniMap
                  slots={splitMiniMap}
                  label={t("plugin.navSidebarItems.row.openInSplitLabel", {
                    title,
                  })}
                />
              ) : null}
            ...
            <DropdownMenu onOpenChange={setIsActionsOpen}>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  aria-label={t("plugin.navSidebarItems.row.optionsLabel", {
                    title,
                  })}
                  className={cn(
      ...
      <ContextMenuContent
        aria-label={t("plugin.navSidebarItems.row.optionsLabel", { title })}
      >
