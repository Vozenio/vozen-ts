...
export function SettingsSidebarContent({
  ...
  return (
    <SectionSidebar
      backLabel={t("settingsMisc.sidebar.backToApp", "Back to app")}
      backTo={appRoutePath}
    ...
    >
      <SectionSidebarLabel>
        {t("settingsMisc.sidebar.settingsLabel", "Settings")}
      </SectionSidebarLabel>
      ...
      {pluginEntries.length > 0 ? (
        <>
          <div className="mt-4">
            <SectionSidebarLabel>
              {t("settingsMisc.sidebar.pluginsLabel", "Plugins")}
            </SectionSidebarLabel>
          </div>
          <div className="mt-1 space-y-0.5">
      ...
      {sections.some((section) => section.id === "archived") ? (
        <>
          <div className="mt-4">
            <SectionSidebarLabel>
              {t("settingsMisc.sidebar.archivedLabel", "Archived")}
            </SectionSidebarLabel>
          </div>
          <div className="mt-1 space-y-0.5">
            {sections
