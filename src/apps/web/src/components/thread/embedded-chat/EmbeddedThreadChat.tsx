...
function EmbeddedThreadChatWithComposer({
  ...
  const labels = useMemo<EmbeddedThreadChatLabels>(
    () => ({
      placeholder: t("thread.composer.placeholder", "Reply…"),
      stopping: t("thread.composer.stopping", "Stopping thread..."),
      provisioning: t("thread.composer.provisioning", "Provisioning thread..."),
      sendError: t("thread.composer.sendError", "Failed to send message"),
    }),
    [t],
  );
