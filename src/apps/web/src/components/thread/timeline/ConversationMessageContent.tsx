    ...
    return (
      <GeneratedConversationMessage
        ...
        sourceName={
          senderIsPluginSideChat
            ? t(
                "thread.timeline.messageContent.sideChatSourceNameFallback",
                "side chat",
              )
            : (senderThreadTitle ??
              t("thread.timeline.messageContent.agentSourceNameFallback", "Agent"))
        }
          ...
          <div className="max-w-full rounded-xl border border-border-seam bg-surface-recessed px-4 py-2.5 text-sm leading-relaxed text-foreground">
            {messageText ? (
              ...
              <p className="text-muted-foreground">
                {t(
                  "thread.timeline.messageContent.sentAttachmentsFallback",
                  "Sent attachments",
                )}
              </p>
            )}
