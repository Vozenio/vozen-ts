    ...
    <PopoverPrimitive.Root open={open} onOpenChange={setOpen}>
      <PopoverPrimitive.Trigger asChild>
        <button
          ...
          aria-label={t(
            "thread.timeline.actionBar.messageActionsAriaLabel",
            "Message actions",
          )}
              ...
              onClick={() => {
                if (action.kind === "copy") {
                  void copyToClipboardWithToast(action.copyText ?? "", {
                    successMessage: null,
                    errorMessage: t(
                      "thread.timeline.actionBar.copyErrorMessage",
                      "Failed to copy",
                    ),
                  }).then((didCopy) => {
                    if (!didCopy) return;
  ...
  const actions: MessageOverflowAction[] = [
    ...(hasCopy
      ? [
          {
            icon: "Copy" as const,
            label: t("thread.timeline.actionBar.copyMessageLabel", "Copy message"),
            onSelect: () => {
    ...
    ...(onEdit
      ? [
          {
            icon: "Edit" as const,
            label: t("thread.timeline.actionBar.editMessageLabel", "Edit message"),
            onSelect: onEdit,
          },
        ]
      : []),
      ...
      ? [
          {
            ...
            label: t("thread.timeline.actionBar.addToChatLabel", "Add to chat"),
      ...
      ? [
          {
            ...
            label: t(
              "thread.timeline.actionBar.sendToMainThreadLabel",
              "Send to main thread",
            ),
      ...
      ? [
          {
            icon: "Fork" as const,
            label: t(
              "thread.timeline.actionBar.forkIntoNewThreadLabel",
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  ...
                  aria-label={t(
                    "thread.timeline.actionBar.moreActionsAriaLabel",
                    "More actions",
                  )}
                >
