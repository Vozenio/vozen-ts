...
function SourceCodeTruncationNotice({
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-2 gap-y-1 px-4 py-3 text-xs text-muted-foreground">
      <span>
        {t("ui.sourceCode.truncationNotice", {
          shown: truncation.renderedLineCount.toLocaleString(),
          total: truncation.totalLineCount.toLocaleString(),
        })}
      </span>
      <Button
        type="button"
